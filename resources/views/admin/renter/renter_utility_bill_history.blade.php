...
<section class="content-header" >
      <div class="container-fluid">
        ...
        <div class="row mb-2">
          ...
          <div class="card inc">
            <div class="text-center m-2 " ><h5  class="badge-info  p-2 rounded d-inline ">Renter Name: <strong >{{$renter->renter_name}}</strong></h5></div>
...
<script type="text/javascript">
  ...
  $(document).ready(function (){
    ...
    var renter_id = '{{$renter_id}}';
     var postData = {};
     postData.renter_id = renter_id;
     ...
     var table = $('#jsTable').DataTable({
        ...
        "pagelength":25,
        "ajax":{
        "url": "{{URL::to('utilitybilldatatable')}}",
        "type":"POST",
        "data": function(d){
        $.extend(d, postData);
